...
.content{background: #f2f2ff;border: 6px solid #3399ff;font-size: 16px;line-height: 22px;margin-bottom: 3px;margin-top: 3px;min-height: 690px;overflow: hidden;padding: 10px;}
...
input[type=text] {border-radius: 5px;padding: 5px 5px;width: 225px; font-size: 15px;font-weight: bold;}
		input[type=submit],input[type=reset] {font-size: 20px;padding: 3px 15px;border: 2px solid;border-radius: 8px; margin-top: 20px;}
</style>
</head>
<body>
